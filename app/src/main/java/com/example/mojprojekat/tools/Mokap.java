...
public class Mokap {
    ...
    public static List<Message> getMesagges() throws ParseException {
        ...
        Message u1 = new Message(1, c2.getEmail(), c1.getEmail(), "Nesto lepo", "bcc", DateUtil.getNow(), "subject1", "content1");
        Message u2 = new Message(2, c2.getEmail(), c1.getEmail(), "Nesto lepse", "bcc", DateUtil.getNow(), "subject2", "content2");
        Message u3 = new Message(3, c3.getEmail(), c1.getEmail(), "Nesto najlepse", "bcc", DateUtil.getNow(), "subject3", "content3");
