...
public class FragmentCreateEmail extends Fragment {

    public static FragmentCreateEmail newInstance() {
        return new FragmentCreateEmail();
    }
    ...
    public void onCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater inflater) {
        ...
        menu.clear();
        inflater.inflate(R.menu.activity_item_create_email, menu);
    }
}
